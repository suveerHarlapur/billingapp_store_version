...
export default class All extends Component{
    ...
    renderItem=({item})=>(
        <ListItem >
            <ListItem.Content style={{borderWidth:1,color:'white'}}>
                ...
                <ListItem.Subtitle style={{marginLeft:RFValue(4)}}>you have sold {item.item} of quantity {item.quantity} at rupees {item.soldRate}
    ...
    render(){
        return(
            <View>
                <MyHeader title="All Sells" navigation={this.props.navigation}/>
                {this.state.allitem.length === 0 ?
            <Text>you have not sold any items </Text>    
